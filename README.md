...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6080e32a5a28e900169810a0
...
To start editing your site, you can use the Sanity interface at https://festive-strawberry-0e32a.sanity.studio/.
...
Generated at `2021-04-22T02:45:58.303Z` by Stackbit version `0.3.50`.